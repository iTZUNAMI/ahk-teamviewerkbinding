...
Menu, Tray, Add, %pr1% (ALT GR+L),ManualeAvviaTeamV
Menu, Tray, Add, %pr2% (ALT GR+P),ManualeAvviaCalc
...
;ALT GR + L Avvia il tool e il team viewer per vederlo MAC
<^>!l::
AvviaTeamV()
return
